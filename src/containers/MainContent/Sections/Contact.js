                                ...
                                <div className="text-white footer-alt">
                                    ...
                                    <div className="float-right">
                                        <ul className="list-inline social pb-0">
                                            <li className="list-inline-item pl-2"><Link to="https://www.facebook.com/PrfctWeek/" className="text-white"><i className="mdi mdi-facebook"></i></Link></li>
                                            <li className="list-inline-item pl-2"><Link to="https://twitter.com/WeekPerfect" className="text-white"><i className="mdi mdi-twitter"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
